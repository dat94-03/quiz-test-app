...
//        //là sinh viên bách khoa cái gì mà mình có theer tư duy 1 chút mà có câu trả lời thì không nên đi hỏi
//
//

//        QuestionManage questionManage = new QuestionManage();
//        QuizzesManage quizzesManage = new QuizzesManage();
//        Question question = QuestionManage.questionsList.get(5);
//        Quiz quiz = QuizzesManage.quizzesList.get(0);
//        LibraryForUs.deleteQuestionOnQuiz(question, quiz);
